...
Status list_number(char* argv,operand **head,operand **tail);
...
int multiply(operand *head1,operand *tail1,operand *head2, operand *tail2, operand **res_head, operand **res_tail);
